...
$resulReceipts = $bdd->bdd->query(" SELECT * FROM receipts WHERE receipt_status = 'Active' AND cookerId = '".$cookerId."' ORDER BY receiptsId DESC LIMIT {$start},{$per_page} ") or die(mysql_error());
